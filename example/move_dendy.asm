# 32-byte iNES header
    ...
    .byte 2             # 32kb prg rom
    .byte 1             # 8Kb chr rom
    .byte %00000001     # Mirroring
    .byte %00001000     # Console Type
    .byte 0             # Mapper/SubMapper
    .byte 0             # PRG-ROM/CHR-ROM MSB
    .byte 0             # PRG-RAM/EEPROM size
    .byte 0             # Chr-RAm size
    .byte %00000011     # Timing (NTSC, PAL, Multi, PAL-Clone)
    .byte 0             # Console Type
    .byte 0             # Miscellaneous ROMS count                 
